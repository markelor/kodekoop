...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-8">
			...
			<div class="portfolio-info">
				<div class="row">
					<div class="col-md-6">
						<h5>@lang('services.stats-what-is')</h5>
					</div>
				</div>
			</div>

			@foreach (Lang::get('services.stats-what-is-descriptions') as $descriptions => $description)
				<p class="mt-2">
				{{$description['text']}}
				</p>
				<dl>
	...
	<div class="row">
		<div class="col">
			<hr class="tall">
			<h4>@lang('services.stats-kodekoop')</h4>
		</div>
	</div>
		...
		<div class="col-lg-12">
			<div class="tabs-quinary">
				<ul class="nav nav-tabs nav-justified">
					<?php $i=0; ?>
					@foreach (Lang::get('services.stats-kodekoop-services') as $services => $service)
						@if ($i == 0)
